...
<div class="span6" id="itmp-tags">
    <?php echo JHtml::_('bootstrap.startAccordion', 'slide-tags', array('active' => 'twitter_card')); ?>

    <?php echo JHtml::_('bootstrap.addSlide', 'slide-tags', JText::_('COM_ITPMETA_TWITTER_CARD'), 'twitter_card'); ?>
    <a class="itp-tag-btn" data-tag="twitter_card_summary" data-tag-type="twitter:card:summary" data-tag-title="<?php echo JText::_('COM_ITPMETA_TWETTER_CARD_SUMMARY');?>"><?php echo JText::_('COM_ITPMETA_TWETTER_CARD_SUMMARY_TAG');?></a>
    <a class="itp-tag-btn" data-tag="twitter_card_summary_large_image" data-tag-type="twitter:card:summary_large_image" data-tag-title="<?php echo JText::_('COM_ITPMETA_TWETTER_CARD_SUMMARY_LARGE_IMAGE_TITLE');?>"><?php echo JText::_('COM_ITPMETA_TWETTER_CARD_SUMMARY_LARGE_IMAGE');?></a>
    <a class="itp-tag-btn" data-tag="twitter_card_title" data-tag-type="twitter:title" data-tag-title="<?php echo JText::_('E');?>"><?php echo JText::_('COM_ITPMETA_TWETTER_CARD_TITLE_TAG');?></a>
    ...
    <a class="itp-tag-btn" data-tag="twitter_card_image_alt" data-tag-type="twitter:image:alt" data-tag-title="<?php echo JText::_('COM_ITPMETA_TWETTER_CARD_IMAGE_ALT');?>"><?php echo JText::_('COM_ITPMETA_TWETTER_CARD_IMAGE_ALT_TAG');?></a>
    <a class="itp-tag-btn" data-tag="twitter_card_app" data-tag-type="twitter:card:app" data-tag-title="<?php echo JText::_('COM_ITPMETA_TWETTER_CARD_APP_TITLE');?>"><?php echo JText::_('COM_ITPMETA_TWETTER_CARD_APP');?></a>
    <a class="itp-tag-btn" data-tag="twitter_card_player" data-tag-type="twitter:card:player" data-tag-title="<?php echo JText::_('COM_ITPMETA_TWETTER_CARD_PLAYER_TITLE');?>"><?php echo JText::_('COM_ITPMETA_TWETTER_CARD_PLAYER');?></a>
    ...
    <a class="itp-tag-btn" data-tag="twitter_card_creator" data-tag-type="twitter:creator" data-tag-title="<?php echo JText::_('COM_ITPMETA_TWETTER_CARD_CREATER');?>"><?php echo JText::_('COM_ITPMETA_TWETTER_CARD_CREATOR_TAG');?></a>
    <a class="itp-tag-btn" data-tag="twitter_card_creator_id" data-tag-type="twitter:creator:id" data-tag-title="<?php echo JText::_('COM_ITPMETA_TWETTER_CARD_CREATER_ID');?>"><?php echo JText::_('COM_ITPMETA_TWETTER_CARD_CREATOR_ID_TAG');?></a>
